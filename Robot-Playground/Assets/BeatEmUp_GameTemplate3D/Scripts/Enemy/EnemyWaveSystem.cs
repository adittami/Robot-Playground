...
public class EnemyWaveSystem : MonoBehaviour {
	...
	IEnumerator LevelComplete(){
        ...
        Debug.Log("complcheck");
        UIManager UI = GameObject.FindObjectOfType<UIManager>();
        //GamePlay.i.TouchControlPannel.SetActive(false);
        UI.ShowMenu("Ko");
        ...
        if (UI != null&&GamePlay.WinCounter!=1)
        {
            Debug.Log("fadeout");
        ...
        else
        {
            ...
            GamePlay.i.YouWin.SetActive(true);
            GamePlay.i.Source.PlayOneShot(GamePlay.i.Win);
            yield return new WaitForSeconds(1f);
            UI.UI_fader.Fade(UIFader.FADE.FadeOut, 1f, 0);
            yield return new WaitForSeconds(1f);
        }
        ...
        GamePlay.Count++;
            GamePlay.i.WinUpdate();
            Debug.Log("cont is " + GamePlay.Count);
    }
}